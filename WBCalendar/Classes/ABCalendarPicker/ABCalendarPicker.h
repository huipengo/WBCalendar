...
@property (weak,nonatomic) IBOutlet id<ABCalendarPickerDelegateProtocol> delegate;
/** Delegate is needed for displaying user information on calendar. */
@property (weak,nonatomic) IBOutlet id<ABCalendarPickerDataSourceProtocol> dataSource;
